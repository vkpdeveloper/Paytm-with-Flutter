...
public class MainActivity extends FlutterActivity implements PaytmPaymentTransactionCallback {
  ...
  public void onTransactionResponse(Bundle inResponse) {
    ...
    for (String key : inResponse.keySet()) {
      parmsMap.put(key, inResponse.getString(key));
    }
  ...
  public void clientAuthenticationFailed(String inErrorMessage) {
    Map<String, Object> parmsMap = new HashMap<>();
    parmsMap.put("error", true);
    parmsMap.put("result", "clinet auth fail");
    sendResponse(parmsMap);
  }
